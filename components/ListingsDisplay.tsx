...
const ListingsDisplay: React.FC<ListingsDisplayProps> = ({ listings, sourceAttributions, isLoading, error, warning }) => {
  if (isLoading) {
    return (
  ...
  return (
    <div className="space-y-8 py-8">
       {warning && (
        <div className="text-amber-800 bg-amber-50 p-4 rounded-lg shadow-md">
          <p><span className="font-bold">Note:</span> {warning}</p>
        </div>
      )}
